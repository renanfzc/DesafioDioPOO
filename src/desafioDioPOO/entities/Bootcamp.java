...
public class Bootcamp {
	...
	private final LocalDate dataIniacial = LocalDate.now();
	...
	public LocalDate getDataIniacial() {
		return dataIniacial;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataIniacial, descricao, devsInscritos, nome);
	}
	@Override
